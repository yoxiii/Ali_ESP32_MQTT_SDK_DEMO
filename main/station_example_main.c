...
int linkkit_main(void)
{
    ...
    */
    ...
    {
        char *sub_topic = "/k0r7zrmL7su/a002/user/get"; ///sys/a13FN5TplKq/mqtt_basic_demo/thing/event/+/post_reply
    ...
    {
        char *pub_topic = "/k0r7zrmL7su/a002/user/get";///sys/a13FN5TplKq/mqtt_basic_demo/thing/event/property/post
